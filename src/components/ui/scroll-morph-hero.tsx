...
const CARDS: CardData[] = [
  ...
  { id: "first-call",   bg: "#0C0E14",  fg: "#fff",    muted: "rgba(255,255,255,0.4)",    border: "rgba(255,255,255,0.08)", iconBg: "rgba(255,255,255,0.08)", iconFg: "#a78bfa",  icon: Phone,       value: "11",      label: "Days to First Call" },
  ...
  { id: "ready",        bg: "#3C61A8",  fg: "#fff",    muted: "rgba(255,255,255,0.5)",    border: "rgba(255,255,255,0.1)",  iconBg: "rgba(255,255,255,0.1)",  iconFg: "#F5D134",  icon: CheckCircle, value: "98%",     label: "Interview Ready" },
