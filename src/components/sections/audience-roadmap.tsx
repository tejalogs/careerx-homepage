...
const PERSONAS = [
  {
    ...
    stat: "82%", statLabel: "of students received an offer within 60 days",
  ...
  },
  {
    ...
    stat: "2.4×", statLabel: "average salary increase for career switchers",
  ...
  },
  {
    ...
    stat: "91%", statLabel: "placement rate across partner university cohorts",
    cta: "Partner with us",
    ctaHref: "#get-started",
  },
  {
    ...
    stat: "60%", statLabel: "reduction in time-to-hire for employer partners",
...
const OUTCOMES = [
  {
    ...
    stat: "Targeted applications outperform spray-and-pray by 3×",
  },
  {
    n: "02",
    ...
    stat: "Candidates who practice pass their first interview at a significantly higher rate",
  },
  {
    n: "03",
    ...
    stat: "Role-fit clarity leads to better offers and stronger negotiation leverage",
  },
];
